...
The ontology, \texttt{drinkonto}, was designed with three principles in mind.
...
\begin{table}[h]
  ...
  \begin{tabular}{@{}llp{7.2cm}@{}}
    ...
    \bottomrule
  \end{tabular}
  \caption{External vocabularies reused by \texttt{drinkonto}.}
  \label{tab:reuse}
\end{table}
...
\begin{table}[h]
  ...
  \begin{tabular}{@{}llp{6.6cm}@{}}
    ...
    \bottomrule
  \end{tabular}
  \caption{Classes defined in \texttt{drinkonto}.}
  \label{tab:classes}
\end{table}
...
\begin{figure}[h]
  ...
  \end{tikzpicture}
  \caption{Summary of \texttt{drinkonto}. Solid arrows are asserted
